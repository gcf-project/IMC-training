...
map.getView().fit([19.382123, -24.377062, 41.991968, -13.080421], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">IMC Leadership Training Attendance</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (106 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The map shows the IMC Leadership Training attendance at the different irrigation schemes held in May 2025<br />';
            }
